            ...
            <main class="flex flex-1 flex-col items-center justify-center p-4">
                <div class="w-full max-w-md space-y-8">
                    <div class="space-y-2 text-center">
                        <h1 class="text-2xl font-semibold tracking-tight text-foreground">{t(lang.get(), "qr.title")}</h1>
                        <p class="text-sm leading-relaxed text-muted-foreground">{t(lang.get(), "qr.instruction")}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center space-y-4">
                                    ...
                                    view! {
                                        <div class="absolute inset-0 flex items-center justify-center rounded-2xl bg-background/90 backdrop-blur-sm">
                                            <div class="flex flex-col items-center gap-2">
                                                ...
                                                <span class="text-sm font-medium text-foreground">{t(lang.get(), "qr.success")}</span>
                                            </div>
                                        </div>
                                    }.into_any()
                                    ...
                                    view! {
                                        <div class="absolute inset-0 flex items-center justify-center rounded-2xl bg-background/90 backdrop-blur-sm">
                                            <div class="flex flex-col items-center gap-2">
                                                ...
                                                <span class="text-sm text-muted-foreground">{t(lang.get(), "qr.waiting")}</span>
                                            </div>
                                        </div>
                                    }.into_any()
                                } else {
                            ...
                            view! {
                                <>
                                    <div class="flex items-center gap-2 text-sm text-muted-foreground">
                                        <span>{t(lang.get(), "qr.validFor")}</span>
                        ...
                        <div class="text-center">
                            <span class="text-xs text-muted-foreground">{t(lang.get(), "qr.requestId")}: </span>
